...
INSERT INTO `cashfloat` VALUES (1,'','from sir Mike',1500.00,'2013-06-08',4,'0');
...
INSERT INTO `cashlift` VALUES (1,'','1 pc. Shim Brush',70.00,'2013-06-08',4,'0'),(2,'','Fuel (Santino)',50.00,'2013-06-08',4,'0');
...
INSERT INTO `categories` VALUES (1,'Preventive Maintenance Services',6),(3,'Change Oil',3),(4,'Exhaust System',0),(5,'Brake System',3);
...
INSERT INTO `color` VALUES (1,'Red'),(2,'Blue'),(3,'Green'),(6,'Sky Blue'),(25,'Yellow'),(10,'Silver'),(24,'Brown'),(23,'Black Forest'),(13,'Dark Red'),(22,'White'),(26,'Aqua Marine');
...
INSERT INTO `company` VALUES (6,'Mugs and Coffee','Cagayan de Oro City','+639277745663','','kennvall@gmail.com','http://mugsandcoffee.com','1');
...
INSERT INTO `customer` VALUES (25,'Kenneth','','Vallejos','Kalye Pogi, Zone 2, Cugman',6,'+639277745663','1');
...
INSERT INTO `dcr` VALUES (1,'2013-06-07',500.00,4,'1'),(2,'2013-06-08',450.00,4,'0'),(3,'2013-06-09',5000.00,4,'0');
...
INSERT INTO `dcrdetails` VALUES (1,6,'Overhaul || 1000.00','2',750.00,1),(1,7,'Yokohama Tire || 5000.00','1',10.00,1),(2,8,'Nagales, Emelie','1',150.00,1),(2,9,'Nagales, Emelie (Downpayment)','1',2500.00,1),(2,10,'Libago Sr., Norberto','2',250.00,1),(3,11,'Nagales, Emelie','1',1500.00,1);
...
INSERT INTO `joborder` VALUES (2,'000002',3,5,' KVP867 -- Toyota',0,NULL,NULL,'2013-06-07',0.00,0.00,'0');
...
CREATE TABLE `jodetails` (
  ...
  CONSTRAINT `jodetails_ibfk_1` FOREIGN KEY (`jo_id`) REFERENCES `joborder` (`jo_id`) ON UPDATE CASCADE
...
INSERT INTO `jodetails` VALUES (2,23,'','',1000.00,'1');
...
INSERT INTO `labortype` VALUES (1,'Car Wash',1,'1'),(2,'Painting',1,'1'),(4,'Breaking',5,'1'),(22,'Change Mirror',1,'1'),(7,'Change Oil',1,'1'),(10,'Change Tire',1,'1');
...
INSERT INTO `tmp_jo_details_cache` VALUES (1,10,'','',75.00),(2,0,'Yokohama Tire','Yokohama tire bought from other supplier',5000.00);
...
INSERT INTO `users` VALUES (3,'Norberto','Quisil','Libago Jr','juntals','827ccb0eea8a706c4c34a16891f84e7b','Poblacion Catarman Camiguin','1',1),(4,'Kenneth','Palmero','Vallejos','kenn','2b45dd79684b41a595b5543904f1574a','Cugman Cagayan de Oro City','1',1),(10,'Emelie Agnes','Q.','Nagales','emz','827ccb0eea8a706c4c34a16891f84e7b','Valencia','1',2);
...
INSERT INTO `vehicle` VALUES (35,'Honda','1'),(3,'Toyota','1'),(28,' Mitsubishi  ','1'),(34,'Ford','1');
...
-- Dump completed on 2013-06-10 10:38:36

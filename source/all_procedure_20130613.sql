...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost` PROCEDURE `sp_editJO`(IN p_jo_id INT, IN p_jo_number VARCHAR(10), IN p_v_id INT, IN p_customer INT, IN p_plate VARCHAR(75), IN p_trnxdate VARCHAR(32), IN p_tax DECIMAL(8,2), IN p_discount DECIMAL(8,2), OUT p_status INT)
BEGIN
/*
...
*/
  ...
  START TRANSACTION;
    ...
    -- calls*/ /*!50003*/ /*!50003 function that processes the master-detail table
...
-- Dump completed on 2013-06-13 23:02:45

...
--
-- Host: localhost
-- Generation Time: May 27, 2013 at 03:15 AM
...
(26, 'palma', 'limakabuk', 'tongbens', NULL, NULL, '1'),
(25, 'palma', 'limakabuk', 'tongbens', NULL, NULL, '1');
...
CREATE TABLE IF NOT EXISTS `joborder` (
  ...
  `trnxdate` date DEFAULT NULL,
  PRIMARY KEY (`jo_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='enforces referential integrity' AUTO_INCREMENT=135 ;
...
(130, '61', 21, 5, '438', 24, '092689566', 'mambajao', '2013-05-15'),
...
(131, 23, '', '3', '3.00', '0.00', '1'),
(130, 0, '14', '12', '0.00', '12.00', '1'),
(130, 22, '', 'sd', '12.00', '0.00', '1'),
(132, 20, '', '12', '12.00', '0.00', '1'),
(134, 20, '', '21', '21.00', '0.00', '1'),
(133, 20, '', '12', '12.00', '0.00', '1');

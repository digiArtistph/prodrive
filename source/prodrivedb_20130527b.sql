...
INSERT INTO `color` VALUES (1,'red'),(2,'blue'),(3,'green'),(6,'skyblue'),(25,'yellow'),(10,'dark black'),(24,'brown'),(23,'dsf'),(13,'dark red'),(22,'white'),(26,'Aqua M');
...
INSERT INTO `dcr` VALUES (2,'2013-05-17',1500.00,4,'1'),(3,'2013-05-18',1250.00,4,'1'),(4,'2013-05-24',1500.00,4,'1'),(5,'2013-05-25',1500.00,4,'1'),(6,'2013-05-26',1500.00,4,'1'),(7,'2013-05-27',1500.00,4,'1'),(8,'2013-05-27',1500.00,0,'1');
...
INSERT INTO `dcrdetails` VALUES (7,56,'Car Wash','ref1',150.00,1),(7,57,'Change Oil','ref1',1750.00,1);
...
CREATE TABLE `joborder` (
  ...
  `trnxdate` date DEFAULT NULL,
  PRIMARY KEY (`jo_id`)
) ENGINE=InnoDB AUTO_INCREMENT=135 DEFAULT CHARSET=latin1 COMMENT='enforces referential integrity';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-05-27 11:26:46

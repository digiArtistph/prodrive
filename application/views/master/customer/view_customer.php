	...
	<table class="regdatagrid">
		...
		<?php foreach ($customers as $customer):?>
			<tr>
                ...
                <td><a class="reggrideditbtn" href="<?php echo base_url() . 'master/customer/section/editcustomer/' . $customer->custid;?>">edit</a>|<a class="reggriddelbtn delcust" href="#" custcode="<?php echo $customer->custid;?>">delete</a></td>
        	</tr>   
		<?php endforeach;?>
		</tbody>
    </table>

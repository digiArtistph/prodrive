	...
	<div id="view_form">
        ...
        <?php foreach ($users as $user):?>
        	<tr>
        		...
        		<td><a class="reggrideditbtn" href="<?php echo base_url() . 'master/users/section/editusers/' . $user->u_id;?>">Edit</a>|<a class="reggriddelbtn deluser" usercode="<?php echo $user->u_id;?>" href="#">delete</a></td>
        	</tr>
        <?php endforeach;?>
        </tbody>
        </table>

...
<div class="toolbar"><a class="cancenewlbtn" href="<?php echo base_url('tranx/joborder'); ?>">Cancel New Job Order</a></div>
	...
	<form class="jo_form">
		...
		<p><label>Vehicle </label><input name="v_id" class="v_id" type="hidden" value="0"/><input readonly="readonly" tabindex="2" class="vehicle" type="text" name="vehicle" /></p>
		<p><label>Tax</label> <input tabindex="3"  type="text" name="tax"/></p>
        <p><label>Discount</label> <input tabindex="4"  type="text" name="discount"/></p>
